...
const RiwayatPajakTutup = ({ navigation, route }) => {
  ...
  const getListItem = async () => {
    ...
    await Api.post('MerchantTutup/view_merchant_tutup', params)
      .then((res) => {
        var body = res.data;
  ...
  return (
    <View style={style.container}>
      <HeaderDate
        title={'Riwayat Tutup Wajib Pajak'}
        back={() => {
          navigation.goBack();
        }}
...
export default RiwayatPajakTutup;
